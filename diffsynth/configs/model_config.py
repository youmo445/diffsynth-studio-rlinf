...
model_loader_configs = [
    ...
    (None, "919d31d872576edee85da494a76b3bd4", ["wan_video_dit"], [WanModel], "civitai"), # cam去掉adapter和t5相关
    (None, "0afc12f0f89f5602ca0fb44998d5fab3", ["wan_video_dit"], [WanModel], "civitai"), # cam去掉adapter
    (None, "e8102511f92a240dba2d577218fcf6f1", ["wan_video_dit"], [WanModel], "civitai"), # cam去掉adapter后训练逐帧动作模块保存的
    (None, "452867c4b22ec0fe62015e2202561f4f", ["wan_video_dit"], [WanModel], "civitai"), # cam去掉adapter后训练IRASim动作模块保存的
    (None, "e2e520f6b0b7307b8a9a8dd5bd8c020a", ["wan_video_dit"], [WanModel], "civitai"), # cam去掉adapter后训练IRASim动作模块保存的abs_action
    (None, "948982ad6c57e8cc51e334334511ba56", ["wan_video_dit"], [WanModel], "civitai"), # cam去掉adapter后训练IRASim动作模块并将动作模块嵌入DiT的block中
    (None, "2df9f0f2bf2da1682b22717ea0d1db48", ["wan_video_dit"], [WanModel], "civitai"), # cam去掉adapter后训练IRASim动作模块并将动作模块嵌入DiT的block中再scale
    (None, "72eb2cd6726a61792fe75c49e2b68d34", ["wan_video_dit"], [WanModel], "civitai"), # cam去掉adapter后训练IRASim动作模块并将动作模块嵌入DiT的block中再scale2
    (None, "bef5b7059ced61357ef5c55eff4cd2f4", ["wan_video_dit"], [WanModel], "civitai"), # cam去掉adapter后训练IRASim动作模块并将动作模块嵌入DiT的block中，动作模块去掉gelu
    (None, "4e9d80607c71d650e185ae3edab2e6be", ["wan_video_dit"], [WanModel], "civitai"), # cam去掉adapter后训练IRASim动作模块并将动作模块嵌入DiT的block中，动作模块去掉gelu
    (None, "9174f2c68848bb65480dd4cc5dcbb6f1", ["wan_video_dit"], [WanModel], "civitai"), # cam去掉adapter后训练IRASim动作模块并将动作模块嵌入DiT的block中，动作模块去掉gelu加上silu，只保留t+action的modulation
    (None, "d8ee7cda0d764f06b42d5313acbb9187", ["wan_video_dit"], [WanModel], "civitai"), # cam去掉adapter后训练Worldeval
